...
public interface OrdenesRepository  extends JpaRepository<Ordenes, Integer>{
    ...
    Ordenes darOrdenesPorId(@Param("id") Integer id, @Param("fecha esperada") Date fecha_esperada, @Param("estado") String estado, @Param("proveedor_nit") Integer proveedor_nit, @Param("sucursal_id") Integer sucursal_id, @Param("cantidad") Integer cantidad, @Param("precio") Integer precio, @Param("recepcion_id") Integer recepcion_id);
    ...
    Ordenes darOrdenesId(@Param("fecha esperada") Date fecha_esperada, @Param("estado") String estado, @Param("proveedor_nit") Integer proveedor_nit, @Param("sucursal_id") Integer sucursal_id, @Param("cantidad") Integer cantidad, @Param("precio") Integer precio, @Param("recepcion_id") Integer recepcion_id);

    @Modifying
    @Transactional
    @Query(value = "UPDATE Ordenes SET estado = 'anulada' WHERE id = :id", nativeQuery = true)
    void actualizarOrdenes(@Param("id") Integer id);
    ...
    void insertarOrdenes(@Param("id") Integer id, @Param("fecha esperada") Date fecha_esperada, @Param("proveedor_nit") Integer proveedor_nit, @Param("sucursal_id") Integer sucursal_id, @Param("cantidad") Integer cantidad, @Param("precio") Integer precio, @Param("recepcion_id") Integer recepcion_id);
